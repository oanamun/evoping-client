...
exports.default = function () {
  ...
  // React _components via the React Intl Babel plugin. An error will be thrown if
  // there are messages in different _components that use the same `id`. The result
